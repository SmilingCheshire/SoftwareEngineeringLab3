...
public class HRCalculatorWorkoutZoneTest {
    ...
    void zones_for_age_40_examples() {
        ...
        assertEquals("Below Zone", HRCalculator.getWorkoutZone(age, 80));   // 44%
        ...
        assertEquals("VO2 Max",   HRCalculator.getWorkoutZone(age, 178));  // 99%
        assertEquals("Above Max", HRCalculator.getWorkoutZone(age, 190));  // 105%
    }
